...
public class NormalTitleBar extends RelativeLayout {
    ...
    public NormalTitleBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        String title = a.getString(R.styleable.NormalTitleBar_titleContent);
        ...
        int color = a.getColor(R.styleable.NormalTitleBar_backgroundColor, Color.parseColor("#F5494C"));
        a.recycle();
